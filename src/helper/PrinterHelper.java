...
public class PrinterHelper {
     ...
     * @throws DocumentException
     */
    public static void saveAndPrintClosingSheetMode2(Context ctx, BaseContainer bc, boolean reprint) throws IOException, DocumentException {
     ...
     * @throws DocumentException
     */
    public static void saveAndPrintClosingSheetMode3(Context ctx, BaseContainer bc, boolean reprint) throws IOException, DocumentException, Exception {
