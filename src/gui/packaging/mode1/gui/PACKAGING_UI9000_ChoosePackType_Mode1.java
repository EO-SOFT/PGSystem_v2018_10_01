...
public final class PACKAGING_UI9000_ChoosePackType_Mode1 extends javax.swing.JDialog {
    ...
    public void loadConfigUcs() {
        ...
        if (pallet_number != -1) {
            ...
            //############# PASSE TO S041 STATE ###############
            UILog.info(String.format("Openning new container for first harness part [%s].",
                    PackagingVars.mode1_context.getTempBC().getHarnessPart()));
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER || evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (result.isEmpty()) {
                    if (Integer.valueOf(GlobalVars.APP_PROP.getProperty("UNIQUE_PALLET_PER_PACK_TYPE")) == 1) {
                        ...
                        if (result.isEmpty()) {
                            ...
                            UILog.severe(ErrorMsg.APP_ERR0016[0],
                                    PackagingVars.mode1_context.getBaseContainerTmp().getPackType(),
                    ...
                    UILog.info(String.format(Helper.ERR0024_PALLET_ALREADY_OPEN, PackagingVars.mode1_context.getTempBC().getHarnessPart().substring(1)));
