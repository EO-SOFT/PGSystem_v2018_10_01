...
//        his_login.create(his_login);
        ...
        //Load DOTMATRIX
        loadDotMatrixCodePatterns(PackagingVars.Packaging_Gui_Mode3.getHarnessTypeBox().getSelectedItem().toString());

        //Load PART NUMBER patterns
        loadPartNumberCodePatterns(PackagingVars.Packaging_Gui_Mode3.getHarnessTypeBox().getSelectedItem().toString());
