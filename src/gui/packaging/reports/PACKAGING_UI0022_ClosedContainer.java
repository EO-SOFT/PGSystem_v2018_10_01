 ...
 */
public class PACKAGING_UI0022_ClosedContainer extends javax.swing.JDialog {
     ...
     */
    public PACKAGING_UI0022_ClosedContainer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.initGui();
        this.refresh();
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    if (PackagingVars.context.getUser().getAccessLevel() == GlobalVars.PROFIL_ADMIN || PackagingVars.context.getUser().getAccessLevel() == GlobalVars.PROFIL_WAREHOUSE_AGENT) {
                        new PACKAGING_UI0010_PalletDetails(null, rootPaneCheckingEnabled, String.valueOf(closed_result_table.getValueAt(closed_result_table.getSelectedRow(), PALLET_NUMBER_COLINDEX)), "", 1, true, true, true).setVisible(true);
                    } else {
                        new PACKAGING_UI0010_PalletDetails(null, rootPaneCheckingEnabled, String.valueOf(closed_result_table.getValueAt(closed_result_table.getSelectedRow(), PALLET_NUMBER_COLINDEX)), "", 1, false, false, false).setVisible(true);
                    }
                }
            }
        }
