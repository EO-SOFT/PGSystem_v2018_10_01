 ...
 */
public class CONFIG_UI0003_CONFIG_USERS extends javax.swing.JFrame {
    ...
    public CONFIG_UI0003_CONFIG_USERS(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        initGui();
        refresh();
