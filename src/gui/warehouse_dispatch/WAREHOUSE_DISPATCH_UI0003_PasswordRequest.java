...
public class WAREHOUSE_DISPATCH_UI0003_PasswordRequest extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ok_btn.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cancel_btn)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(ok_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addGap(3, 3, 3)))
                .addGap(22, 22, 22))
        );
...
//        his_login.create(his_login);
    ...
    private void ok_btnKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ok_btnKeyTyped
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (checkLoginAndPass()) {
                connect();
            } else {
